...
class GetStudentEvaluationsUseCase @Inject constructor(
    private val studentRepository: StudentRepository,
    val dataStore : DataStore<Token>,
    private val dataGroupStore : DataStore<GroupInfo>
) {

    operator fun invoke(userId : Long) : Flow<Resource<List<Evaluations>>> = flow{
        try {
            ...
            val recordResponse = studentRepository.getStudentEvaluations(token,groupId!!.toLong(),userId)
