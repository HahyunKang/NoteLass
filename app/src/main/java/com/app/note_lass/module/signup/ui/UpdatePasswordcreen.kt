...
import com.app.note_lass.ui.component.DialogResetPassword
        ...
        Column(
            ...
            Row(
                ...
                BasicTextField(
                    ...
                    onValueChange = { it ->
                        emailValue.value = it
                        resetPasswordViewModel.onEvent(RegistrationFormEvent.EmailChanged(emailValue.value))
                ...
                RectangleEnabledWithBorderButton(
                    ...
                    text = "전송",
                    onClick = {
                        resetPasswordViewModel.emailRequest(emailValue.value,isToast = {
            ...
            BasicTextField(
                ...
                onValueChange = { it ->
                    ...
                    resetPasswordViewModel.onEvent(RegistrationFormEvent.ValidationChanged(emailValidationValue.value))
                },
                textStyle = NoteLassTheme.Typography.twenty_600_pretendard,
                modifier = Modifier
                    .fillMaxWidth()
                        ...
                        if(!emailValidated.value) {
                            Icon(
                                ...
                                modifier = Modifier.clickable {
                                    resetPasswordViewModel.emailValidate(emailValue.value, emailValidationValue.value,
                                        isToast = {
            ...
            BasicTextField(
                ...
                onValueChange = { it ->
                    password = it
                    resetPasswordViewModel.onEvent(RegistrationFormEvent.PassWordChanged(password))
                    if (state.repeatedPasswordError == null) resetPasswordViewModel.onEvent(
