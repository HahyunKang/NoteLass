...
class PostRecordUseCase @Inject constructor(
    ...
    operator fun invoke(userId :Long,recordBody: RecordBody) : Flow<Resource<NoteResponseBody<Nothing>>> = flow{
        try {
            ...
            val recordResponse = studentRepository.postRecord(token, groupId!!, userId, recordBody)
