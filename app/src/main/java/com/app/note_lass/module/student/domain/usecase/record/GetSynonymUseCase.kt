...
class GetSynonymUseCase @Inject constructor(
    private val studentRepository: StudentRepository,
    val dataStore : DataStore<Token>,
    private val dataGroupStore : DataStore<GroupInfo>
) {

    operator fun invoke(word:String) : Flow<Resource<List<String>>> = flow{
        try {
            ...
            val recordResponse = studentRepository.getSynonym(token,word)
